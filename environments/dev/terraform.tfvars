...
project_name          = "spiffy-ai-dev"
project_id            = "spiffy-ai-dev"
project_id_for_quotas = "inner-tokenizer"

subnet_count     = 3
region_default   = "us-west1"    # Oregon
region_secondary = "us-central1" # Iowa

cidr_block_default_region                        = "10.0.0.0/16"
...
cidr_block_secondary_region                        = "10.1.0.0/16"
...
compute_zones_gpus_default_region   = ["us-west1-a", "us-west1-b", "us-west1-c"]
compute_zones_gpus_secondary_region = ["us-central1-a", "us-central1-c"]
...
enable_private_build_worker_pool = true
...
gke_dws_default_cluster_region        = "secondary_region"
gke_dws_default_cluster_compute_zones = ["us-central1-a", "us-central1-c"]
gke_dws_secondary_cluster_enabled     = true
gke_dws_secondary_cluster_region        = "secondary_region"
gke_dws_secondary_cluster_compute_zones = ["us-central1-b", "us-central1-f"]

# Elastic search
elastic_cloud_gcp_region = "gcp-us-west1"
...
pen_tester_bastion_host_enabled = true
pen_tester_ssh_pub_key          = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIBC3Dwtvua/m59iK9i/KaG9Mir2R6iTIMulUqJAYk2jt kali@kali"
pen_tester_src_ip_address       = "35.182.86.97/32"

temporal_host           = "us-west1.gcp.api.temporal.io:7233"
temporal_namespace      = "spiffy-dev.w79qu"
text_embed_endpoint_url = "https://text-embed-default.dev.spiffy.ai/embed"
