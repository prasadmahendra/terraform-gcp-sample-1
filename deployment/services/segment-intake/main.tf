...
module "segment-intake-topic" {
  source                 = "../../../modules/create_pubsub_topic"
  topic_name             = "segment-intake-topic"
...
module "service" {
  ...
  container_command_args = [
    "spiffy/service/gateways/segment_webhooks/__main__.py"
  ]
  ...
  env = [
    ...
    },
    {
      ...
      value = module.segment-intake-topic.topic_id
    },
    {
      name  = "REDIS_HOST"
