...
variable "service_type" {
  description = "The type of service (test, main). test=use for development, main=this is used by devs and monitoring"
  type        = string
  default     = "main"
}

variable "timeout" {
  description = "Timeout before the cloud run job fails"
  type        = string
  default     = "7200s"
}
