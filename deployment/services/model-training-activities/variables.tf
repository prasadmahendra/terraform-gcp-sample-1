...
variable "gke_default_cluster_region" {
  description = "The region of the default GKE cluster"
  type        = string
}

variable "gke_default_cluster_name" {
  description = "The name of the default GKE cluster"
  type        = string
}

variable "gke_secondary_cluster_region" {
  description = "The region of the secondary GKE cluster"
  type        = string
}
...
variable "gke_k8_inference_namespace" {
  description = "The Kubernetes namespace for inference services"
  type        = string
}